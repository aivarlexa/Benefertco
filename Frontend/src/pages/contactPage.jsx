...
export default function ContactPage() {
  ...
  const buttonClass = 'inline-flex items-center justify-center gap-2 rounded-full bg-[#123f2a] px-6 py-4 font-bold text-white shadow-[0_12px_28px_rgba(18,63,42,0.22)] transition hover:-translate-y-0.5 hover:bg-[#0b3320] disabled:opacity-60 disabled:pointer-events-none'
    ...
    <section className={`${sectionClass} grid items-stretch gap-8 pt-28 sm:gap-10 sm:pt-32 lg:grid-cols-[0.9fr_1.1fr]`}>
      <div className="rounded-[32px] bg-[#123f2a] p-[clamp(28px,5vw,56px)] text-white">
        ...
        <div className="space-y-3 text-white/80">
          <p className="flex items-start gap-2.5 break-words">
            <MapPin className="mt-1 shrink-0" size={18} /> Leemansstraat 2, 4251 LD - Werkendam, the Netherlands
          </p>
          <p className="flex items-start gap-2.5 break-words">
            <Mail className="mt-1 shrink-0" size={18} /> benefertico@gmail.com
          </p>
          <p className="flex items-start gap-2.5">
            <Phone className="mt-1 shrink-0" size={18} /> +31183505268
          </p>
          <p className="flex items-start gap-2.5">
            <Globe2 className="mt-1 shrink-0" size={18} /> Benefertico Nutrition
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="grid gap-4 rounded-3xl border border-[#1f6f4324] bg-white/80 p-[clamp(24px,4vw,42px)] shadow-[0_24px_70px_rgba(22,48,35,0.12)]" aria-label="Inquiry form">
        <label className="grid gap-2 font-bold text-[#123f2a]">
          Name
          <input 
            className="min-w-0 rounded-2xl border border-[#1f6f4324] bg-[#fbfdf9] px-4 py-3.5 outline-none focus:border-[#1f6f43]" 
            type="text" 
            name="name" 
            required 
          />
        ...
        <label className="grid gap-2 font-bold text-[#123f2a]">
          Message
          <textarea 
            className="min-w-0 resize-y rounded-2xl border border-[#1f6f4324] bg-[#fbfdf9] px-4 py-3.5 outline-none focus:border-[#1f6f43]" 
            name="message" 
            rows="5" 
            required 
          />
